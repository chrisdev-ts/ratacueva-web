  ...
  const columns: ColumnDef<Sale>[] = [
    ...
    },
    {
      ...
      cell: (info) => {
        ...
        return (
          <Body className="text-text truncate max-w-[120px]">{label}</Body>
        );
      },
    },
  ];
      ...
      <div className="flex flex-col gap-6">
        <div className="flex justify-between items-center flex-wrap gap-6">
          <div className="flex items-center gap-4">
            ...
            <Body className="text-text whitespace-nowrap">
              entradas por página
            </Body>
          </div>
        ...
        <div className="flex justify-between items-center flex-wrap gap-6">
          <Body className="text-text">
            Mostrando {totalRecords > 0 ? startItem : 0} de {itemsPerPage} en{" "}
