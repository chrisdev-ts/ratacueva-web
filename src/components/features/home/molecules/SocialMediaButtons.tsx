...
const SocialMediaButtons = () => {
  ...
  const socialPlatforms = [
    ...
    {
      name: "X (Twitter)",
      image: "https://upload.wikimedia.org/wikipedia/commons/9/95/X_logo_black.svg",
      url: "https://x.com"
    },
    {
      name: "YouTube",
    ...
    {
      name: "Discord",
      image: "https://assets-global.website-files.com/6257adef93867e50d84d30e2/636e0a6918e57475a843f59f_icon_clyde_black_RGB.svg",
      ...
      {socialPlatforms.map((platform) => {
        return (
          ...
          >
            ...
            />
            <span className="text-gray-800 text-sm font-semibold truncate">{platform.name}</span>
          </Button>
        )
      })}
    </div>
