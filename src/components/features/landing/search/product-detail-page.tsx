    ...
    <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-6">
      <div className="self-stretch py-8 inline-flex flex-col justify-start items-start gap-8">
            ...
            <div className="self-stretch flex-1 p-6 bg-zinc-800 rounded-lg flex flex-col justify-center items-start gap-6 overflow-hidden">
              ...
              {product.description && product.description.length > 250 && (
                <button
                  ...
                  className="self-stretch h-11 min-h-11 px-4 py-2.5 bg-pink-600 hover:bg-pink-700 transition-colors rounded-[99px] inline-flex justify-center items-center gap-3"
                >
          ...
          <div className="flex-1 inline-flex flex-col justify-start items-center gap-8 w-full">
            <div className="self-stretch p-6 bg-zinc-800 rounded-lg flex flex-col justify-start items-center gap-12 overflow-hidden">
              ...
              <div className="self-stretch flex flex-col justify-start items-start gap-4">
                <button className="self-stretch h-11 min-h-11 px-4 py-2.5 bg-pink-600 hover:bg-pink-700 transition-colors rounded-[99px] inline-flex justify-center items-center gap-3">
                  <div className="justify-start text-white text-base font-bold ">Comprar ahora</div>
                </button>
                <button className="self-stretch h-11 min-h-11 px-4 py-2.5 rounded-[99px] outline outline-1 outline-offset-[-1px] outline-pink-600 inline-flex justify-center items-center gap-3 text-pink-600 hover:bg-pink-600 hover:text-white transition-colors">
        ...
        {relatedProducts.length > 0 && (
          <button className="self-stretch h-11 min-h-11 px-4 py-2.5 bg-pink-600 hover:bg-pink-700 transition-colors rounded-[99px] inline-flex justify-center items-center gap-3 mx-auto">
            ...
            {reviews.map((review) => (
              ...
              >
                ...
                <div className="justify-start text-white text-xl font-normal ">
                  {review.content}
                  {review.content.length > 100 && ( // Example condition for "Leer más"
