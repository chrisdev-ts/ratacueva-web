      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-zinc-300 text-base lg:text-lg mb-6 leading-relaxed">
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <Link
                    key={index}
                    href={social.href}
                    className="w-10 h-10 bg-pink-600 hover:bg-pink-700 transition-colors rounded-full flex justify-center items-center"
                  >
          ...
          {/* Navigation Column */}
          <div>
            <h4 className="text-white text-lg lg:text-xl font-bold mb-6">Navegación</h4>
          ...
          {/* Support Column */}
          <div>
            <h4 className="text-white text-lg lg:text-xl font-bold mb-6">Soporte</h4>
            <div className="space-y-3">
              {[
                "Centro de ayuda",
                "Garantías",
          ...
          {/* Contact Column */}
          <div>
            <h4 className="text-white text-lg lg:text-xl font-bold mb-6">Contacto</h4>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="text-zinc-300 text-base">support@ratacueva.com</p>
                  <p className="text-zinc-300 text-base">pedidos@ratacueva.com</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="text-zinc-300 text-base">+506 2222-3333</p>
                  <p className="text-zinc-300 text-base">+506 8888-9999</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
        ...
        <div className="border-t border-zinc-800 mt-12 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            <p className="text-zinc-400 text-sm lg:text-base text-center lg:text-left">
