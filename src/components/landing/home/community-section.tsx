            ...
            <div className="h-56 bg-zinc-800 hover:bg-zinc-750 transition-colors rounded-lg cursor-pointer group">
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-white font-semibold">Reseñas en Facebook</p>
            ...
            <div className="h-56 bg-zinc-800 hover:bg-zinc-750 transition-colors rounded-lg cursor-pointer group">
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-white font-semibold">Posts de Instagram</p>
            ...
            <div className="h-56 bg-zinc-800 hover:bg-zinc-750 transition-colors rounded-lg cursor-pointer group">
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-white font-semibold">Videos de YouTube</p>
            ...
            <div className="h-56 bg-zinc-800 hover:bg-zinc-750 transition-colors rounded-lg cursor-pointer group">
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-white font-semibold">Videos de TikTok</p>
            ...
            <div className="h-56 bg-zinc-800 hover:bg-zinc-750 transition-colors rounded-lg cursor-pointer group">
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-white font-semibold">Posts de X</p>
